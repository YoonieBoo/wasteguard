    ...
    <main className="relative flex min-h-dvh w-full items-center justify-center overflow-hidden bg-[#f8fbf8] px-4 py-6 sm:px-6 lg:py-8">
      ...
      <div className="relative z-10 flex w-full max-w-[1280px] justify-center lg:h-[calc(100dvh-4rem)] lg:justify-end">
        <Image
          ...
          height={1190}
          priority
          className="pointer-events-none absolute left-1/2 top-[-105px] z-10 block h-auto w-[250px] -translate-x-1/2 drop-shadow-[0_18px_22px_rgba(22,99,65,0.11)] sm:left-[-72px] sm:top-1/2 sm:w-[390px] sm:translate-x-0 sm:-translate-y-1/2 lg:left-auto lg:right-[350px] lg:w-[470px] lg:drop-shadow-[0_24px_28px_rgba(22,99,65,0.13)] xl:w-[520px]"
        />
