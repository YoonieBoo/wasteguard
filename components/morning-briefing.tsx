  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-end justify-center p-4 sm:items-center">
      ...
      <div className="relative w-full max-w-[420px] animate-in fade-in-0 slide-in-from-bottom-4 duration-300 sm:zoom-in-95 sm:slide-in-from-bottom-0">
        <div className="rounded-t-[1.5rem] bg-primary px-5 py-5">
        ...
        <div className="rounded-b-[1.5rem] bg-white px-5 pb-6 pt-5 shadow-[0_24px_60px_rgba(35,88,62,0.2)]">
          <div className="space-y-2">
            <div className="flex items-center justify-between rounded-[1rem] bg-primary/10 px-4 py-3">
            ...
            <div className="flex items-center justify-between rounded-[1rem] bg-secondary/70 px-4 py-3">
